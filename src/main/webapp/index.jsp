                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <p class="lead text-white mt-lg-3 mb-lg-5">Kohi is a Sydney based specialty coffee rostery.</p>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <p class="lead text-white mt-lg-3 mb-lg-5"> We provide a variety of coffee options sourced from different parts of the globe.</p>

                                    <a href="products.html" class="btn custom-btn">Explore our offering</a>
                                </div>
                            </div>
                        </div>
                    </div>
