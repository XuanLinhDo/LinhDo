    ...
    <body>
        ...
        <main>
            ...
            <header class="site-header section-padding-img site-header-image">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 header-info">
                            <h1>
                                <span class="d-block text-dark">24/7 LET'S TALK</span>
                ...
                <img src="images/header/talk-about-coffee.jpg" class="header-image img-fluid" alt="coffee">
            </header>
                        ...
                        <div class="col-lg-6 col-12 mt-5 ms-auto">
                            <div class="row">
                                ...
                                <div class="col-6 border-top border-end contact-info">
                                    ...
                                    <p class="text-muted">123 Bourke Street, Surry Hills, NSW 2010</p>
                                </div>
