                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-info d-flex">
                                <div>
                                    <h2 class="product-title mb-0">SugarPlum FanFare Edition Parachutes</h2>

                                    <span class="product-info-item-label">Taste:</span>
                                     <span class="product-info-item-value">Candied cherry, plum and cocoa.</span>
                                </div>

                                <small class="product-price text-muted ms-auto mt-auto mb-5">$13</small>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-info d-flex">
                                <div>
                                    <h2 class="product-title mb-0">Awol - Decaf Blend</h2>

                                    <span class="product-info-item-label">Taste:</span>
                                    <span class="product-info-item-value">Sweet caramel, mild citrus & cherry flavours with a buttery mouthfeel.</span>
                                </div>

                                <small class="product-price text-muted ms-auto mt-auto mb-5">$22</small>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 mt-3 mt-lg-0">
                                <h3 class="modal-title" id="exampleModalLabel">SugarPlum FanFare Edition Parachutes</h3>

                                <p class="product-price text-muted mt-3">$13</p>

                                <p class="product-p">Quatity: <span class="ms-1">4</span></p>

                                <div class="border-top mt-4 pt-3">
                                    <p class="product-p"><strong>Total: <span class="ms-1">$52</span></strong></p>
                                </div>
